...
${OBJECTDIR}/_ext/1885453440/tinyxmlparser.o: ../Public/TinyXml/tinyxmlparser.cpp 
	...
	${RM} $@.d
	$(COMPILE.cc) -O2 -fPIC  -MMD -MP -MF $@.d -o ${OBJECTDIR}/_ext/1885453440/tinyxmlparser.o ../Public/TinyXml/tinyxmlparser.cpp

${OBJECTDIR}/_ext/1809219144/Buff.o: ../Public/Buff.cpp 
	${MKDIR} -p ${OBJECTDIR}/_ext/1809219144
	${RM} $@.d
	$(COMPILE.cc) -O2 -fPIC  -MMD -MP -MF $@.d -o ${OBJECTDIR}/_ext/1809219144/Buff.o ../Public/Buff.cpp
...
${OBJECTDIR}/_ext/1809219144/CXmlConfig.o: ../Public/CXmlConfig.cpp 
	${MKDIR} -p ${OBJECTDIR}/_ext/1809219144
	${RM} $@.d
	$(COMPILE.cc) -O2 -fPIC  -MMD -MP -MF $@.d -o ${OBJECTDIR}/_ext/1809219144/CXmlConfig.o ../Public/CXmlConfig.cpp

${OBJECTDIR}/_ext/768003749/snippets.o: ../Public/simpleini/snippets.cpp 
	${MKDIR} -p ${OBJECTDIR}/_ext/768003749
	${RM} $@.d
	$(COMPILE.cc) -O2 -fPIC  -MMD -MP -MF $@.d -o ${OBJECTDIR}/_ext/768003749/snippets.o ../Public/simpleini/snippets.cpp
...
${OBJECTDIR}/_ext/768003749/ConvertUTF.o: ../Public/simpleini/ConvertUTF.c 
	${MKDIR} -p ${OBJECTDIR}/_ext/768003749
	${RM} $@.d
	$(COMPILE.c) -O2 -fPIC  -MMD -MP -MF $@.d -o ${OBJECTDIR}/_ext/768003749/ConvertUTF.o ../Public/simpleini/ConvertUTF.c

${OBJECTDIR}/_ext/1885453440/tinyxmlerror.o: ../Public/TinyXml/tinyxmlerror.cpp 
	${MKDIR} -p ${OBJECTDIR}/_ext/1885453440
	${RM} $@.d
	$(COMPILE.cc) -O2 -fPIC  -MMD -MP -MF $@.d -o ${OBJECTDIR}/_ext/1885453440/tinyxmlerror.o ../Public/TinyXml/tinyxmlerror.cpp

${OBJECTDIR}/_ext/1809219144/Archive.o: ../Public/Archive.cpp 
	${MKDIR} -p ${OBJECTDIR}/_ext/1809219144
	${RM} $@.d
	$(COMPILE.cc) -O2 -fPIC  -MMD -MP -MF $@.d -o ${OBJECTDIR}/_ext/1809219144/Archive.o ../Public/Archive.cpp

${OBJECTDIR}/_ext/1809219144/Stream.o: ../Public/Stream.cpp 
	${MKDIR} -p ${OBJECTDIR}/_ext/1809219144
	${RM} $@.d
	$(COMPILE.cc) -O2 -fPIC  -MMD -MP -MF $@.d -o ${OBJECTDIR}/_ext/1809219144/Stream.o ../Public/Stream.cpp

${OBJECTDIR}/LoginServer.o: LoginServer.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} $@.d
	$(COMPILE.cc) -O2 -fPIC  -MMD -MP -MF $@.d -o ${OBJECTDIR}/LoginServer.o LoginServer.cpp

${OBJECTDIR}/_ext/1809219144/VarList.o: ../Public/VarList.cpp 
	${MKDIR} -p ${OBJECTDIR}/_ext/1809219144
	${RM} $@.d
	$(COMPILE.cc) -O2 -fPIC  -MMD -MP -MF $@.d -o ${OBJECTDIR}/_ext/1809219144/VarList.o ../Public/VarList.cpp

${OBJECTDIR}/_ext/1885453440/tinyxml.o: ../Public/TinyXml/tinyxml.cpp 
	${MKDIR} -p ${OBJECTDIR}/_ext/1885453440
	${RM} $@.d
	$(COMPILE.cc) -O2 -fPIC  -MMD -MP -MF $@.d -o ${OBJECTDIR}/_ext/1885453440/tinyxml.o ../Public/TinyXml/tinyxml.cpp

${OBJECTDIR}/_ext/1885453440/tinystr.o: ../Public/TinyXml/tinystr.cpp 
	${MKDIR} -p ${OBJECTDIR}/_ext/1885453440
	${RM} $@.d
	$(COMPILE.cc) -O2 -fPIC  -MMD -MP -MF $@.d -o ${OBJECTDIR}/_ext/1885453440/tinystr.o ../Public/TinyXml/tinystr.cpp
