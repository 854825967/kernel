...
#ifdef WIN64
#pragma comment(lib, "../../Library/NedmallocLib/libnedmalloc_x64_md.lib")
#else
#ifdef WIN32
#pragma comment(lib, "../../Library/NedmallocLib/libnedmalloc_md.lib")
#endif //WIN32
#endif //WIN64
#endif //CUSTOMALLOC
...
/*! \brief Equivalent to nedprealloc2((nedpool *) 0, size, mem, size, 0, M2_RESERVE_MULT(8)) */
NEDMALLOCEXTSPEC NEDMALLOCNOALIASATTR NEDMALLOCPTRATTR char* nedstrdup(const char* str) THROWSPEC;
...
NEDMALLOCDEPRECATED NEDMALLOCEXTSPEC NEDMALLOCNOALIASATTR char*  nedpstrdup2(const char* str) THROWSPEC;
/*! \ingroup v2malloc
