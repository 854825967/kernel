...
static SymbolListItem nedmallocpatchtable[]={
	...
	{ { "_strdup",          0, "", 0/*(PROC) strdup*/ },             modules, { "nedstrdup",      (PROC) nedstrdup      } },
...
static char *sysstrdupX(const char* str)
{
	return ((char * (*)(const char*))GetProcAddress(FindMSVCRTForCaller(), "strdup"))(str);
}
